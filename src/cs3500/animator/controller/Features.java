...
/**
 * This interface represents all of the features that could be carried out.
 * It should be implemented by whatever class can mutate the model accordingly. (Controller).
 * Note: non of the methods throw an error. This is because the implementor should take care of
 * the errors that might be thrown.
 */
