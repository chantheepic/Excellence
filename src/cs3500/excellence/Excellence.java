...
public class Excellence {
  ...
  private static final class Builder{
    ...
    private void parseOut(String out){
      this.output = out;
    }

    private void parseView(String view) throws FileNotFoundException {
      if(view.equals("text")){
        this.view = new TextualView(System.out);
      }
