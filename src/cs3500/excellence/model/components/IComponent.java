...
/**
 * Extended Interface with setter methods for Component
...
public interface IComponent extends IROComponent {
  ...
  /**
   * Adds a motion to the component. Each motion must be added in chronological order and
   * each end tick must be adjacent the next start tick.
